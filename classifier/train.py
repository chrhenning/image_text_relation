...
tf.flags.DEFINE_string("autoencoder_checkpoint_dir", "",
                       "Path to a pretrained autoencoder model.")
tf.flags.DEFINE_string("train_dir", "",
                       "Directory for saving and loading model checkpoints.")
tf.flags.DEFINE_boolean("train_encoder", False,
                        "Whether to train encoder submodel variables.")

...
tf.flags.DEFINE_string("embedding_checkpoint_dir", "",
                       "Path to pretrained embeddings.")
tf.flags.DEFINE_string("train_dir", "",
                       "Directory for saving and loading model checkpoints.")
tf.flags.DEFINE_boolean("train_inception", False,
                        "Whether to train inception submodel variables.")
tf.flags.DEFINE_boolean("train_embeddings", False,
                        "Whether to train embedding variable.")                        
tf.flags.DEFINE_boolean("finetune_model", False,
                        "Whether to finetune the model (only tiny changes).")
...
def main(unused_argv):
  ...
  with g.as_default():
    ...
    model = auto_encoder.AutoEncoder(
        model_config, mode="train", train_inception=FLAGS.train_inception, train_embeddings=FLAGS.train_embeddings)
    model.build()
